...
pygame.mixer.music.load('./racer/Ace of Base - Happy Nation.mp3')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./racer/Enemy.png")  # Загрузка изображения врага
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load(
            "./racer/Player1.png"), (100, 110))  # Загрузка изображения игрока
        self.rect = self.image.get_rect()
...
class Coins (pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./racer/coins.png")  # Загрузка изображения монеты
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        pygame.mixer.music.load('./racer/crash.wav')  # Загрузка звука аварии
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        pygame.mixer.Sound('./racer/coinss.mp3').play()  # Воспроизведение звука монеты
        SCORE += 1  # Увеличение очков
