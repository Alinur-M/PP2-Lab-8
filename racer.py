...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./Lab_8/racer/Enemy.png")  
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load(
            "./Lab_8/racer/Player1.png"), (100, 110))  
        self.rect = self.image.get_rect()
...
class Coins (pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./Lab_8/racer/coins.png")  
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        pygame.mixer.music.load('./Lab_8/racer/crash.wav')  
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        pygame.mixer.Sound('./Lab_8/racer/coinss.mp3').play()  
        SCORE += 1  
        C.move()  
